function load() {
	...
	titleBarText.innerText = "Off Topic" + " | " + "This is a test channel description"
	...
	var widthOffset = 264 + parseInt(titleBar.style.marginLeft) + parseInt(titleBar.style.marginRight) + parseInt(titleBar.style.paddingLeft) + parseInt(titleBar.style.paddingRight)
